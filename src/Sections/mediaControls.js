...
// media functions
import { playMedia, stopMedia, nextMedia, pauseMediaPlayer } from '../lib/mediaFunctions';
...
export default function MediaControls() {
    ...
    return (
        ...
        <div className="position-fixed vw-100 text-center" style={{bottom: "5px"}}>
            ...
            <Button variant="primary" className="me-1" onClick={pauseMediaPlayer} disabled={!isPlayerPlaying}>
